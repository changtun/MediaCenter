...
public class CustomImageView extends ImageView
{
        ...
        public void handleMessage(android.os.Message msg)
        {
            ...
            switch (msg.what)
            {
                ...
                case SCALING:
                    ...
                    {
                        isFinish = true;
                        if (CustomImageView.this.mOnViewClickListener != null && !isClicked)
                        {
                            isClicked = true;
                            CustomImageView.this.mOnViewClickListener.onViewClick(CustomImageView.this);
                        }
                        else
                        {
                            isClicked = false;
    ...
    {
        void onViewClick(CustomImageView view);
    }
