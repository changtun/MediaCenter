...
import com.pbi.center.domain.LRCInfo;

/**
 * <Functional overview> <Functional Details>
 * 
 * @author
 * @version [Version Number, 2014-9-11]
 * @see [Relevant Class/Method]
 * @since [Product/Module Version]
 */
public class CustomLrcView extends TextView
{
    ...
    public CustomLrcView(Context context)
    {
        super(context);
        init();
    }
    
    public CustomLrcView(Context context, AttributeSet attrs, int defStyle)
    {
